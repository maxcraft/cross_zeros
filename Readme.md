This is a simple implementation of a simple game. However I tried to define four difficulties: _noob_, _easy_, _normal_, _hard_. In all difficulties except _hard_ the player has a first move.
